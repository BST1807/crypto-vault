...
function interchangeContainers() {
    var container2 = document.getElementById('token2');
    var container3 = document.getElementById('token3');
...
// if((document.querySelector('#acurrency')).value==='token3'){
//     interchangeContainers();
// };
function redirectToPage(){
    ...
    } else if (selectedCurrency === 'token3') {
        if (document.getElementById('c3').innerHTML === '<!-- token3 -->') {
            window.location = "addt3.html";
            // interchangeContainers();
        } else {
            alert('You have already added this currency');
